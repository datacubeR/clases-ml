...
author: '<span> <span id = "name" >Alfonso Tobar Arancibia </span> <br><span style = "font-size: 75%;">Data Scientist<br>18-05-2021</span> </span> '
...
Normalmente estamos acostumbrados a calcular funciones, donde teniendo un valor de X obtenemos un valor de y siempre y cuando conozcamos la función.
...
.pull-right[
```{r, echo = F, eval = TRUE, out.width= 500}
...
knitr::include_graphics("img/PROPER.png")
```
...
$$E[y | X] = \sum_{i = 0}^p \beta_i X_i + \epsilon_i,\, p: \text{ Número de Features}$$
...
knitr::include_graphics("img/UNDERFITTING.png")
```
...
En caso de dudas [ver docs](https://scikit-learn.org/stable/modules/model_evaluation.html)
]
